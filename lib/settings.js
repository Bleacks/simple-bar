...
export const data = {
  ...
  displayOnlyIcon: { label: 'Display only process icon', type: 'checkbox', fullWidth: true },
  ...
  naturalScrollWidget: {label: 'Natural Scroll', type: 'checkbox' },
  ...
  memoryWidgetOptions: {
    label: 'Memory',
    infos: [
      'Uses few commands to determine memory pressure',
      'Keep refresh rate relatively high to avoid unnecessary system stress'
    ]
  },
  naturalScrollWidgetOptions: {
    label: 'Natural Scroll',
    infos: [
      'Shows MacOS\' natural scroll direction',
      'Switches natural scroll direction on click'
    ]
  },
  ...
  vpnShowConnectionName: { label: 'Display the connection name in the widget', type: 'checkbox', fullWidth: true },
  ...
  identifiers: { label: 'Identifiers', type: 'text', placeholder: 'celo,bitcoin,ethereum' },
  ...
  showColor: { label: 'Show colored output for market change', type: 'checkbox' },
