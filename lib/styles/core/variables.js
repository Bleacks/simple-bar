...
:root {
  ...
  --grey: ${Theme.colors[scheme].grey};
  --cyan: ${Theme.colors[scheme].cyan};
  --black: ${Theme.colors[scheme].black};
  --white: ${Theme.colors[scheme].white};
  --minimized: ${Theme.colors[scheme].minimized};
  --hidden: ${Theme.colors[scheme].hidden};
  --widgets-background: ${Theme.colors[scheme].widgetsBackground};
  --widgets-border: ${Theme.colors[scheme].widgetsBorder};
  ...
  --bar-height: ${compactMode ? Theme.colors[scheme].compactBarHeight : Theme.colors[scheme].barHeight};
