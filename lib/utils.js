...
export const sortWindows = (windows) =>
  windows.sort((a, b) => {
    a.isHidden = a['is-hidden']
    b.isHidden = b['is-hidden']
    a.isMinimized = a['is-minimized']
    b.isMinimized = b['is-minimized']
    a.isShowed = !a.isHidden && !a.isMinimized
    b.isShowed = !b.isHidden && !b.isMinimized
    if (a.isShowed !== b.isShowed) {
      return b.isShowed
    }
